...
function comp(array1, array2) {
  //your code here
  if (array1 === null || array1 === 0 || array2 === 0 || array2 === null) return false;

  const checkArr1 = [...array1].sort((a, b) => a - b);

  const checkArr2 = array2.map(el => Math.sqrt(el)).sort((a, b) => a - b);

  return checkArr2.every((el, index) => el === checkArr1[index]);
}
...
console.log(
  comp(
    [121, 144, 19, 161, 19, 144, 19, 11],
    [13 * 13, 121 * 121, 144 * 144, 19 * 19, 161 * 161, 19 * 19, 144 * 144, 19 * 19]
  )
); // false
console.log(comp(0, 0)); // false
